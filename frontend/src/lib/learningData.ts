...
export const WORD_CATEGORIES: WordCategory[] = [
  ...
  },
  {
    ...
    words: [
      ...
      { word: "hurt", label: "Hurt" },
      { word: "hungry", label: "Hungry" },
      { word: "cute", label: "Cute" },
      { word: "full", label: "Full" },
    ],
  },
  {
    id: "actions",
    ...
    words: [
      ...
      { word: "sleep", label: "Sleep" },
      { word: "play", label: "Play" },
      { word: "run", label: "Run" },
      { word: "swim", label: "Swim" },
      { word: "read", label: "Read" },
      { word: "write", label: "Write" },
      { word: "sit", label: "Sit" },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "horse", label: "Horse" },
      { word: "rabbit", label: "Rabbit" },
      { word: "cow", label: "Cow" },
      { word: "elephant", label: "Elephant" },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "orange", label: "Orange" },
      { word: "pizza", label: "Pizza" },
  ...
  },
  {
    ...
    icon: "🌦️",
    words: [
      { word: "rain", label: "Rain" },
      { word: "snow", label: "Snow" },
      { word: "fire", label: "Fire" },
      { word: "water", label: "Water" },
      { word: "sun", label: "Sun" },
      { word: "moon", label: "Moon" },
    ],
  },
  {
    id: "time",
    ...
    words: [
      ...
      { word: "morning", label: "Morning" },
      { word: "night", label: "Night" },
...
export const SENTENCE_CATEGORIES: SentenceCategory[] = [
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "s19", words: ["sleep", "now", "please"],    display: "Sleep now, please" },
      { id: "s20", words: ["read", "book", "now"],       display: "Read a book now" },
      { id: "s21", words: ["eat", "apple", "now"],       display: "Eat an apple now" },
      { id: "s22", words: ["drink", "milk", "please"],   display: "Drink milk, please" },
    ],
  },
  {
    id: "family_s",
    ...
    sentences: [
      ...
      { id: "s28", words: ["baby", "sleep", "now"],      display: "Baby, sleep now" },
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "s37", words: ["hurt", "now"],               display: "Hurt now" },
      { id: "s38", words: ["hungry", "eat", "please"],   display: "Hungry, eat please" },
    ],
  },
  {
    id: "questions_s",
  ...
  },
  {
    ...
    sentences: [
      ...
      { id: "s52", words: ["run", "fast"],               display: "Run fast" },
      { id: "s53", words: ["go", "outside", "now"],      display: "Go outside now" },
    ],
  },
  {
    id: "animals_s",
    ...
    sentences: [
      ...
      { id: "s55", words: ["fish", "swim", "fast"],      display: "Fish swim fast" },
      { id: "s56", words: ["horse", "run", "fast"],      display: "Horse runs fast" },
      { id: "s57", words: ["elephant", "big"],           display: "Elephant is big" },
  ...
  },
  {
    ...
    icon: "🍎",
    sentences: [
      { id: "s60", words: ["eat", "pizza", "now"],       display: "Eat pizza now" },
      { id: "s61", words: ["more", "milk", "please"],    display: "More milk, please" },
