...
# --- ASL sentence corpus (natural English-like order for decoding + LM) ---
# Bigram LM: only words in the classifier vocabulary are kept at init.
# Avoid meaningless pairs (e.g. "thank" + "help") and "now"-first triples that
# biased decoding toward signing NOW before the verb; prefer verb/topic + "now".
_RAW_SENTENCE_CORPUS = [
    ...
    ["repeat", "please"],
    ["slow", "please"],
    # Daily activities (time last: go home now — not now go home)
    ["eat", "food", "now"],
    ["drink", "water", "now"],
    ["go", "home", "now"],
    ["go", "school", "now"],
    ...
    ["why", "no"],
    ["why", "sorry"],
    # Social / greetings (meaningful thanks — not "thank help")
    ["hello", "friend"],
    ["hello", "family"],
    ["hi", "friend"],
    ["goodbye", "friend"],
    ...
    ["no", "water"],
    ["hello", "good"],
    # Time expressions (prefer topic–comment without leading "now" for short imperatives)
    ["today", "go", "school"],
    ["today", "go", "home"],
    ["today", "happy"],
    ["today", "tired"],
